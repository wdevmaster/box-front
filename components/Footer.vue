      ...
      footer#site-footer
        section.footer-upper.wrapper
          ...
          section.page-product-addons.row
            ...
            .large-4.columns
              div {{ $t('Enviamos a {c} excepto {co}.', {c: 'Europa', co: 'UK, Noruega, Andorra y Suiza'}) }}
            .large-4.columns
              div {{ $t('{cl} clientes ya han sorprendido con Boxify.', {cl: '2000'}) }}
            strong
        .row.footer-widgets
          .columns.footer-widgets-grid_wide
            .row
              .small-12.medium-4.large-4.columns.footer-widget.footer-widget__footer-nav
                h3.widget__title {{ $t('Mas Boxify') }}
                ul.vertical.menu
                  li
                    a(href='/pages/preguntas-frecuentes' :title="$t('Preguntas Frecuentes')") {{ $t('Preguntas Frecuentes') }}
                  li
                    a(href='https://boxifygifts.typeform.com/to/jfm2Hr' :title="$t('¿Eres Ilustrador/a?')") {{ $t('¿Eres Ilustrador/a?') }}
                  li
                ...
                .widget__desc.rte-raw
                  ul.footer-info
                    a(href='https://www.facebook.com/weareboxify')
                      li
                        i.b-icon.b-icon-facebook
                    a(href='https://www.instagram.com/boxifygifts')
                      li
                        i.b-icon.b-icon-instagram
                    a(href='https://www.linkedin.com/weareboxify')
                      li
                        i.b-icon.b-icon-linkedin
                    a(href='https://www.pinterest.com/weareboxify')
                      li
                        i.b-icon.b-icon-pinterest
                    a(href='https://www.youtube.com/boxifygifts')
                      li
                        i.b-icon.b-icon-youtube
                  img.footer-badge(src='https://cdn.shopify.com/s/files/1/2578/6058/files/mejor.jpg?v=1584478144')
                  a(href='https://tree-nation.com/profile/impact/boxify#co2' target='_blank' style='position:relative;cursor:pointer;inline-block;z-index:999;')
                    img.footer-badge(src='https://tree-nation.com/images/tracking/label-co2-website-white-en.png')
                  script(src='https://tree-nation.com/js/track.js')
                  script.
                    treenation_track("5f29865224328");
        .footer-bottom
          .footer-languages.row.text-center
            .m-auto
        ...
        .row
          .small-12.medium-12.large-6.columns
            span.visually-hidden {{ $t('Pagos aceptados') }}
            ul.menu.payment-types-icons.payment-icons
              li
                svg.icon(xmlns='http://www.w3.org/2000/svg' role='img' viewbox='0 0 38 24' width='38' height='24' aria-labelledby='pi-american_express')
                  title#pi-american_express American Express
                  g(fill='none')
              ...
              li
                svg.icon(version='1.1' xmlns='http://www.w3.org/2000/svg' role='img' x='0' y='0' width='38' height='24' viewbox='0 0 165.521 105.965' xml:space='preserve' aria-labelledby='pi-apple_pay')
                  title#pi-apple_pay Apple Pay
              ...
              li
                svg.icon(xmlns='http://www.w3.org/2000/svg' role='img' viewbox='0 0 38 24' width='38' height='24' aria-labelledby='pi-bancontact')
                  title#pi-bancontact Bancontact
              ...
              li
                svg.icon(xmlns='http://www.w3.org/2000/svg' role='img' viewbox='0 0 38 24' width='38' height='24' aria-labelledby='pi-google_pay')
                  title#pi-google_pay Google Pay
              ...
              li
                svg.icon(viewbox='0 0 38 24' xmlns='http://www.w3.org/2000/svg' role='img' width='38' height='24' aria-labelledby='pi-master')
                  title#pi-master Mastercard
                  path(opacity='.07' d='M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z')
                  path(fill='#fff' d='M35 1c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2h32')
                  circle(fill='#EB001B' cx='15' cy='12' r='7')
              ...
              li
                svg.icon(viewbox='0 0 38 24' xmlns='http://www.w3.org/2000/svg' width='38' height='24' role='img' aria-labelledby='pi-paypal')
                  title#pi-paypal PayPal
                  path(opacity='.07' d='M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z')
                  path(fill='#fff' d='M35 1c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2h32')
              ...
              li
                svg.icon(xmlns='http://www.w3.org/2000/svg' role='img' viewbox='0 0 38 24' width='38' height='24' aria-labelledby='pi-shopify_pay')
                  title#pi-shopify_pay Shop Pay
              ...
              li
                svg.icon(viewbox='0 0 38 24' xmlns='http://www.w3.org/2000/svg' role='img' width='38' height='24' aria-labelledby='pi-visa')
                  title#pi-visa Visa
                  path(opacity='.07' d='M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z')
                  path(fill='#fff' d='M35 1c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2h32')
